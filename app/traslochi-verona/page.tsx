      ...
      <section className="p-4 flex flex-col gap-8">
        ...
        <article className="w-full bg-base-300 rounded-xl p-10">
          ...
          <ul className="list-disc pl-8 mb-5">
            <li>
              <span className="font-bold">Esperienza:</span>
              {`Con anni di
            ...
            <li>
              <span className="font-bold">Personalizzazione:</span>
              {`Riconosciamo
            ...
            <li>
              <span className="font-bold">{`Affidabilità:`}</span>
              {`La tua
              fiducia è la nostra priorità. Ci impegniamo a offrire un servizio
              affidabile e professionale in ogni fase del processo di trasloco.
              Puoi contare su di noi per gestire i tuoi beni con la massima cura
              e attenzione.`}
            </li>
          </ul>
          <p>
