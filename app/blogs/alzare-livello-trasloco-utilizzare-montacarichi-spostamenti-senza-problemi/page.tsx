    ...
    <Padding>
      ...
      <section className="p-4 flex flex-col gap-8">
        <article className="w-full bg-base-300 rounded-xl p-10">
          ...
          <p className="mb-5">
            <strong>Scopri i vantaggi dei montacarichi:</strong>{" "}
            {`I montacarichi
          ...
          <p className="mb-5">
            <strong>{`Pianifica l'utilizzo dei montacarichi`}:</strong>{" "}
            {`Prima
            del trasloco, pianifica quando e come utilizzerai i montacarichi.
          ...
          <p className="mb-5">
            <strong>Scegli il montacarichi giusto:</strong>{" "}
            {`Esistono diversi
