  ...
  return (
    <div className="flex justify-start lg:flex-row flex-col gap-3">
      ...
      <Link
        ...
        className="flex flex-col mx-auto lg:ml-[9.3%] w-fit gap-2 bg-base-300 lg:py-0 py-3 px-5 items-center justify-center rounded-xl hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-110"
      >
