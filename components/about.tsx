...
const About = () => {
  return (
    <>
      ...
      <div className="flex w-full lg:gap-20 justify-center align-middle h-screen">
        <div className="w-96">
        ...
        <div className="w-full h-full flex justify-center align-middle">
          <div className="bg-slate-100 w-96 h-96 my-auto bg-opacity-80 backdrop-blur-md rounded-2xl shadow-2xl">
